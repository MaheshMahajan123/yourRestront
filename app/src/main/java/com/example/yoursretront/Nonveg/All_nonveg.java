...
public class All_nonveg extends AppCompatActivity {
    TextView eye;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_nonveg);
        eye = findViewById(R.id.eye);
        imageView3 = findViewById(R.id.imageView3);
        addtocart = findViewById(R.id.addtocart);
        discription = findViewById(R.id.discription);
        tr = findViewById(R.id.trrnon);
        getIncomingIntent();
...
//                    ft.replace(R.id.trrnon, fragment);
//                    ft.addToBackStack("datil");
//                    ft.commit();
//                }
                Intent i=new Intent(getApplicationContext(), Start_page.class);
                startActivity(i);
                Toast.makeText(All_nonveg.this, "upload sucessfull", Toast.LENGTH_SHORT).show();
            }
        });
    }
}