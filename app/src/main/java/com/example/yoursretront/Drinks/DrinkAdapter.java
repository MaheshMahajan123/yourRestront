...
public class DrinkAdapter extends RecyclerView.Adapter<DrinkAdapter.ImageViewHolder> {
    private Context mContextt;
    private List<Uploadfil> mUploadss;
    private String TAG = "adapterTAG";
  //  private OnItemClickListener mListener;

    public DrinkAdapter(Context contextt, List<Uploadfil> uploads) {
        mContextt = contextt;
        mUploadss = uploads;
    }
    ...
    public ImageViewHolder onCreateViewHolder(@Nullable ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContextt).inflate(R.layout.drinks_layout, parent, false);
    ...
    public void onBindViewHolder(ImageViewHolder holder, final int position) {
        ...
        holder.parent_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mContextt, All_Drinks.class);
                Log.d(TAG, "onClick: clicked on: " + new Intent(mContextt, All_Drinks.class));
